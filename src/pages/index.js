        ...
        <div className="max-w-4xl text-center z-10">
          ...
          <div className="mt-7 md:text-lg text-gray-800 space-y-5">
            <p>
              ...
              thinkers. Attendees will make concrete progress on 3-5 moonshot projects, all of which
          ...
          <div className="mt-10 md:mt-7">
            <h2 className="text-2xl">Presented by</h2>
            <div className="flex justify-center items-center md:space-x-8 flex-col md:flex-row ">
              {hosts?.map((host) => (
                <div
                  className="flex flex-row items-center space-x-3 mt-3 md:w-auto w-56"
                  key={host.name}
                >
                  <Image
                    src={`/images/${host.avatar}`}
                    width={48}
                    height={48}
                    alt={host.name}
                  ...
                  <a
                    href={host.href}
                    target="_blank"
                    className="border-b border-gray-600/10 hover:border-[#1A439E]/50 hover:text-[#1A439E] transition-all ease-in-out duration-200 relative group"
                  >
                    {host.name}
...
const hosts = [
  {
    ...
    href: "https://x.com/danielgolliher",
  },
  {
    name: "Maximum New York",
    avatar: "logo-mny.png",
